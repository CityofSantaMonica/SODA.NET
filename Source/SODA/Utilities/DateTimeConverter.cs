...
{
    /// <summary>Helper class for converting Unix timestamps to local DateTime</summary>
    public class DateTimeConverter
    {
        public static readonly DateTime UnixEpoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);

        /// <summary>Convert a Unix timestamp into its local DateTime representation.</summary>
