...
{
    /// <summary>Helper class for validating Socrata "4x4" resource identifiers.</summary>
    public class FourByFour
    {
        ...
        /// <summary>Test whether the specified input string is a valid Socrata "4x4" resource identifier.</summary>
        ...
        /// <summary>Test whether the specified input string is an invalid Socrata "4x4" resource identifier.</summary>
        /// <param name="testFourByFour">An input string to test.</param>
